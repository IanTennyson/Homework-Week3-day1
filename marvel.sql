...
SELECT 'Ian Tennyson' FROM people WHERE name = 'Ian Tennyson';
...
--You can use IN and add manually, Or BETWEEN two values that will delete everything between those numbers
DELETE FROM people WHERE id IN (2, 4, 6);
